-- Group count and aggregate sum per query. Must match every other engine:
--   Q1/Q4 -> 200 groups, 3000078095504.6
--   Q2    ->  40 groups,  120015240211.4
--   Q3    -> 400 groups, 1199919067064.6
